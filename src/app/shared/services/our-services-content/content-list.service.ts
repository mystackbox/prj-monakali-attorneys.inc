...
export class ContentListService {
    ...
    servicesItems = [
      { 
        ...
        list: '<ul><li>Action and application proceedings</li> <li>Evictions and Spoliation Proceedings </li> </ul>'
      },

      { 
        title: 'PERSONAL INJURY', 
        list: '<ul><li>Road Accident Fund Claims</li> <li>Silicosis and related Claims against Mines</li></ul>'
      },

      { 
        title: 'DECEASED ESTATES ADMIN', 
